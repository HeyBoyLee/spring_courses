...
public class HystrixCommand4ObservableTest {
    ...
    public void testObservable() throws Exception {
        ...
        System.out.println("testObservable: 线程Id:"+Thread.currentThread().getId());
        // single()是堵塞的
        ...
        hotObservable.subscribe(new Observer<String>() {
            ...
            public void onNext(String v) {
                System.out.println("onNext: 线程Id:"+Thread.currentThread().getId());
        ...
        hotObservable.subscribe(new Action1<String>() {
            ...
            public void call(String v) {
                System.out.println("call: 线程Id:"+Thread.currentThread().getId());

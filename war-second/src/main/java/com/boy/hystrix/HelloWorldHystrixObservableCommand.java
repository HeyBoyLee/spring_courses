...
//    return super.resumeWithFallback();
    return Observable.just("resumeWithFallback");
  }
...
//                      observer.onError(getExecutionException());	// 直接抛异常退出，不会往下执行
  ...
  public static void main(String[] args) {
    HelloWorldHystrixObservableCommand obs = new HelloWorldHystrixObservableCommand("HI");
    obs.observe().subscribe(new Observer<String>() {
      @Override
